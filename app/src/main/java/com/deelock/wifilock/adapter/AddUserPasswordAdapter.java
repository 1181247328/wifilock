...
public class AddUserPasswordAdapter extends RecyclerView.Adapter<AddUserPasswordAdapter.ViewHolder> {

    private Context context;
    private int layoutId;
    private List<User> data;

    public AddUserPasswordAdapter(Context context, List<User> data){
