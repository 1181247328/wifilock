...
import com.deelock.wifilock.overwrite.GestureLockView.Mode;
...
public class GestureLockViewGroup extends RelativeLayout {
     ...
     */
    private int mNoFingerInnerCircleColor = 0xFF01bff2;
    /**
     ...
     */
    private int mFingerOnColor = 0xFF01bff2;
    /**
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (mGestureLockViews == null)
        {
            ...
            mPaint.setStrokeWidth(mGestureLockViewWidth * 0.08f);
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        switch (action)
        {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mOnGestureLockViewListener != null && setFlag){
                    if (mChoose.size() < 5){
    ...
    public void setFlag(boolean flag){
        setFlag = flag;
        if (!setFlag){
            mAnswer = SPUtil.getGesture(getContext());
        }
    }
